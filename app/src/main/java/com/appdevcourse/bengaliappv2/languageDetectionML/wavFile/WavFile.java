package com.appdevcourse.bengaliappv2.languageDetectionML.wavFile;
...
//                Log.e("block align desired: ",Integer.toString(wavFile.blockAlign));
//                Log.e("block align have :",Integer.toString(wavFile.bytesPerSample * wavFile.numChannels));
//                Log.e("number of channel :",Integer.toString(wavFile.numChannels));
